...
@section('content')
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="tabs[name]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">表标题</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="tabs[title]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/tab/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
{field: 'name', title: '表名称', sort: true,hide:false},
{field: 'title', title: '表标题', sort: true,hide:false},

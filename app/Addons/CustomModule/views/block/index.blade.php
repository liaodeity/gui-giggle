...
@section('content')
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="blocks[module_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">视图块名称</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="blocks[name]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/block/create')}}" class="layui-btn layui-btn-sm data-add-btn"
        ...
        layui.use(['form', 'table', 'laydate', 'systemGui'], function () {
            ...
            table.render({
                ...
                cols: [[
                   ...
                   {field: 'id', title: '块ID', sort: true,hide:true},
{field: 'module_id', title: 'MODULE_ID', sort: true,hide:false},
{field: 'name', title: '视图块名称', sort: true,hide:false},

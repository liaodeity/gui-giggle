...
@section('content')
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">MODULE_ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="module_tabs[module_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">表ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="module_tabs[tab_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">外键表ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="module_tabs[foreign_tab_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">连接符</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="module_tabs[joiner]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/module_tab/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
{field: 'module_id', title: 'MODULE_ID', sort: true,hide:false},
{field: 'tab_id', title: '表ID', sort: true,hide:false},
{field: 'foreign_tab_id', title: '外键表ID', sort: true,hide:false},
{field: 'joiner', title: '连接符', sort: true,hide:false},

...
@section('content')
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="modules[name]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/module/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
{field: 'name', title: '模块名称', sort: true,hide:false},

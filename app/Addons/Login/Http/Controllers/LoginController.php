...
namespace App\Addons\Login\Http\Controllers;
...
class LoginController extends Controller
{
    ...
    public function admin ()
    {
        ...
        return view ('login::login.admin_login', compact ('loginType', 'remember'));
    }
    ...
    public function agent ()
    {
        ...
        return view ('login::login.agent_login', compact ('loginType'));
    }

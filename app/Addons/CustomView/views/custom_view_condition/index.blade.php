...
@section('content')
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">自定义视图ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_conditions[custom_view_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">字段ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_conditions[field_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">连接类型</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_conditions[type]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">比较类型</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_conditions[comparator]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">内容</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_conditions[data_value]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/custom_view_condition/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
@section('footer')
    <script>
        layui.use(['form', 'table', 'laydate', 'systemGui'], function () {
            ...
            table.render({
                elem: '#currentTableId',
                url: '{{url('admin/custom_view_condition')}}',
                toolbar: '#toolbarDemo',
...
{field: 'custom_view_id', title: '自定义视图ID', sort: true,hide:false},
{field: 'field_id', title: '字段ID', sort: true,hide:false},
{field: 'group_type', title: '分组', sort: true,hide:false},
{field: 'type', title: '连接类型', sort: true,hide:false},
{field: 'comparator', title: '比较类型', sort: true,hide:false},
{field: 'data_value', title: '内容', sort: true,hide:false},

...
@section('content')
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_fields[custom_view_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">字段ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_view_fields[field_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                        <label class="layui-form-label">是否隐藏</label>
                        <div class="layui-input-inline">
                            <select name="custom_view_fields[is_hide]" lay-filter="is_hide">
                                <option value=""></option>
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/custom_view_field/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
@section('footer')
    <script>
        layui.use(['form', 'table', 'laydate', 'systemGui'], function () {
            ...
            table.render({
                elem: '#currentTableId',
                url: '{{url('admin/custom_view_field')}}',
                toolbar: '#toolbarDemo',
...
{field: '_is_hide', title: '是否隐藏', sort: true,hide:false},

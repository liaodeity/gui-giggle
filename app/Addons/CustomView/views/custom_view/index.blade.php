...
@section('content')
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">自定义视图</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_views[name]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">自定义视图标题</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="custom_views[title]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                        <label class="layui-form-label">是否默认视图</label>
                        <div class="layui-input-inline">
                            <select name="custom_views[is_default]" lay-filter="is_default">
                                <option value=""></option>
                        ...
                        <div class="layui-input-inline">
                            <select name="custom_views[status]" lay-filter="status">
                                <option value=""></option>
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/custom_view/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
{field: 'name', title: '自定义视图', sort: true,hide:false},
{field: 'title', title: '自定义视图标题', sort: true,hide:false},
{field: '_is_default', title: '是否默认视图', sort: true,hide:false},

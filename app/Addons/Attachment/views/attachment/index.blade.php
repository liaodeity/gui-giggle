...
@section('content')
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">附件唯一码</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[uuid]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">路径</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[path]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">名称</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[title]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">MD5值</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[md5]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">SHA1值</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[sha1]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">文件类型</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[mine_type]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                                <label class="layui-form-label">后缀名</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[suffix]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                        <label class="layui-form-label">状态</label>
                        <div class="layui-input-inline">
                            <select name="attachments[status]" lay-filter="status">
                                <option value=""></option>
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="attachments[user_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/attachment/create')}}" class="layui-btn layui-btn-sm data-add-btn"
...
{field: 'uuid', title: '附件唯一码', sort: true,hide:false},
{field: 'path', title: '路径', sort: true,hide:true},
{field: 'title', title: '名称', sort: true,hide:false},
{field: 'md5', title: 'MD5值', sort: true,hide:false},
{field: 'sha1', title: 'SHA1值', sort: true,hide:false},
{field: 'mine_type', title: '文件类型', sort: true,hide:false},
{field: 'suffix', title: '后缀名', sort: true,hide:false},
{field: 'size', title: '附件大小byte', sort: true,hide:false},
{field: 'use_number', title: '使用次数', sort: true,hide:false},
{field: 'last_at', title: '最后使用时间', sort: true,hide:false},
{field: '_status', title: '状态', sort: true,hide:false},
{field: 'user_id', title: '上传人', sort: true,hide:false},

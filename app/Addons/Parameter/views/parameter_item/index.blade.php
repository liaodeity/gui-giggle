...
@section('content')
                    ...
                    <form class="layui-form layui-form-pane" action="">
                        <div class="layui-form-item">
                            <div class="layui-inline">
                                <label class="layui-form-label">PARAMETER_ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="parameter_items[parameter_id]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                        <label class="layui-form-label">键</label>
                        <div class="layui-input-inline">
                            <select name="parameter_items[key]" lay-filter="key">
                                <option value=""></option>
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="parameter_items[item]" autocomplete="off" class="layui-input">
                                </div>
                            </div><div class="layui-inline">
                        <label class="layui-form-label">状态</label>
                        <div class="layui-input-inline">
                            <select name="parameter_items[status]" lay-filter="status">
                                <option value=""></option>
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="parameter_items[color]" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-inline">
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            <a href="{{url('admin/parameter_item/create')}}" class="layui-btn layui-btn-sm data-add-btn"> {{__('message.buttons.create')}}
            </a>
...
{field: 'parameter_id', title: 'PARAMETER_ID', sort: true,hide:false},
{field: '_key', title: '键', sort: true,hide:false},
{field: 'item', title: '名称', sort: true,hide:false},
{field: '_status', title: '状态', sort: true,hide:false},
{field: 'color', title: '颜色', sort: true,hide:false},
{field: 'sort', title: '排序', sort: true,hide:false},
